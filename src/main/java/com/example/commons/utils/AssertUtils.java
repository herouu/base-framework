...
public final class AssertUtils {
    ...
    public static void notBlank(String text) {
        notBlank(text, "[Assertion failed] - this String argument must have length; it must not be null or empty");
    }
    ...
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException((StringUtils.isNotBlank(message) ? message + " " : "") + "Object of class [" + (obj != null ? obj.getClass().getName() : "null") + "] must be an instance of " + type);
        }
    }
